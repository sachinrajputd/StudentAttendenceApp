...
public class ViewAttendanceByFacultyActivity extends Activity {
	...
	DBAadapter dbAdapter = new DBAadapter(this);
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		for(AttendanceBean attendanceBean : attendanceBeanList)
		{
			...
			{
				DBAadapter dbAdapter = new DBAadapter(ViewAttendanceByFacultyActivity.this);
		...
		listAdapter = new ArrayAdapter<String>(this, R.layout.viewattendencelist, R.id.labelAttendance, attendanceList);
