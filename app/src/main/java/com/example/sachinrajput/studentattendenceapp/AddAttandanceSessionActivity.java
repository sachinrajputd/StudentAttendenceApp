...
import com.example.sachinrajput.studentattendenceapp.bean.AttendanceBean;
import com.example.sachinrajput.studentattendenceapp.bean.AttendanceSessionBean;
import com.example.sachinrajput.studentattendenceapp.bean.FacultyBean;
import com.example.sachinrajput.studentattendenceapp.bean.StudentBean;
import com.example.sachinrajput.studentattendenceapp.context.ApplicationContext;
import com.example.sachinrajput.studentattendenceapp.db.DBAadapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		submit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				DBAadapter dbAdapter = new DBAadapter(AddAttandanceSessionActivity.this);
